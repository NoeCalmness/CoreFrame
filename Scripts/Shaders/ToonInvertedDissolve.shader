...
Shader "HYLR/Toon/ToonInvertedDissolve"
{
    Properties
    {
        ...
        [Toggle(_INVERT_LIGHT)] _InvertLight ("InvertLight", int) = 1
    ...
    SubShader 
    {
        ...
        Pass
        {
            Cull Front ZWrite On ColorMask 0
        ...
        Pass
        {
            ...
            #pragma shader_feature _INVERT_LIGHT
