...
public class Module_Gift : Module<Module_Gift>
{
    public const string EventGiveGiftSuccess = "EventGiveGiftSuccess";//送礼成功
    public const string EventGiftUpdate = "EventGiftUpdate";//更新礼物列表
    public const string NpcPlayGiveGiftEvent = "NpcPlayGiveGiftEvent";//播送礼动画
    ...
    void _Packet(ScNpcGift p)
    {
        switch (p.result)
        {
            case 0: if (moduleNpc.curNpc != null) DispatchModuleEvent(EventGiveGiftSuccess, moduleNpc.curNpc.npcId, curGift.itemTypeId); break;
